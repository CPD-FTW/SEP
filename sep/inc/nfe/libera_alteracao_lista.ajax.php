...
<?php
	...
	function funcaoData($data,$estilo){
		if(isset($data) && $data != ""){
			if($estilo == "view"){
				if($data!= "0000-00-00"){
					$partes = explode("-",$data);
...
?>
	<table width="100%">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td width="767" align="left" title="<?php echo $nome;?>"><b><?php echo $nome_curto;?></b><br /><i>Data de Cadastro: <?php print funcaoData($datainicio,"view"); ?></i></td>
