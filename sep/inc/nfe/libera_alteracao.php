	...
	<tr>
		...
		<td align="center">
			<form method="post" id="frmLiberarPrestNfe" onsubmit="return false">
				...
				<fieldset>
				<legend>Liberar Altera&ccedil;&atilde;o do  Cadastro</legend>
				<table width="100%">
					<tr>
						<td width="24%" align="left">N&uacute;mero do Documento: </td>
					...
					<tr>
						<td align="left" colspan="2">
							...
							onclick="acessoAjax('inc/nfe/libera_alteracao_ativar.ajax.php','frmLiberarPrestNfe','divlistanfe')" />
						</td>
					</tr>
				</table>
				</fieldset>
