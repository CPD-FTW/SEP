...
<fieldset><legend>Resumo</legend>
	...
	<tr>
		<td align="left">N&uacute;mero de NFe divirgentes: </td>
		<td align="left"><input name="txtNfEmitidas" type="text" id="txtNfEmitidas" size="20" class="texto" value="<?php echo $nf_emitidas?>" /></td>
		<td align="left" colspan="3">
			<input name="btNfEmitidas" type="button" id="btNfEmitidas" value="Detalhes" class="botao" onclick="document.getElementById('tipo').value=1;acessoAjax('inc/fiscal/divergencias_lista.ajax.php','frmDivirgencias','divDivirgenciasDetalhes')" />
		</td>
	</tr>
