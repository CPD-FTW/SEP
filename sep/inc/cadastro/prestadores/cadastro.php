	...
	<form  method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
		...
		<table id="bigtable" width="100%">
            ...
            <tr>
         	...
         	<tr>
         		<td>
         			<input type="checkbox" id="txtRegimeEspecial" name="txtRegimeEspecial" value="1" <?php if($regimeEspecial > 0){echo "checked=\"cheched\""; }?>> Regime especial</input>
         		</td>
         	</tr>
		</table>
		</fieldset>
