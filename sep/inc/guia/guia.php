    ...
    <td align="center">    
		<form method="post" id="frmGuia">
			...
			<table align="left">
                ...
                <tr>
                    <td colspan="5">
                    <label><input name="rdGuia" checked="checked" type="radio" value="G" /> Guias</label>
                    <label><input name="rdGuia" type="radio" value="A" /> Guias Avulsas</label>
                    <label><input name="rdGuia" type="radio" value="T" /> Guias de Tomadores</label></td>
                </tr>
				<tr>
					<td colspan="2">
