...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="130">
  <tr>
	...
	<a href="index.php" class="menuTopo">
		<?php if($CONF_BRASAO){ echo "<img src=../img/brasoes/".rawurlencode($CONF_BRASAO)." style='max-height:100px;'>";} ?>
	</a>
    </td>
    <td width="85%" align="left" valign="middle" style="padding-left:2px;">
    ...
    <br />
    <b class="secretariaTitulo" style="color:#F00;font-size:24px">AMBIENTE DE TESTE</b>
    </td>
  </tr>
</table>